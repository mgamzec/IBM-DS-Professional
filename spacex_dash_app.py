...
launch_sites = spacex_df['Launch Site'].sort_values().unique()
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        launch_sites_data = filtered_df[filtered_df['Launch Site']==entered_site]
        fig = px.pie(launch_sites_data, 
        names= 'class', 
...
def get_scatter_plot(entered_site,entered_payload):
        ...
        if entered_site == 'ALL':
            ...
            launch_sites_data = filtered_df[filtered_df['Launch Site']==entered_site]
            fig = px.scatter(launch_sites_data,x='Payload Mass (kg)',y='class',
            # names= "Booster Version Category", 
